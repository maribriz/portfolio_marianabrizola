...
const experiences = [
  {
    ...
    scope: "B2B SaaS",
    description: "Led brand and communication strategy for agency clients, combining audience research, data analysis and digital media planning to drive acquisition and creative briefs.",
  },
  {
    period: "2023 - 2024",
