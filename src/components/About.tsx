        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <div className="relative aspect-[3/4] bg-background/10 overflow-hidden group">
              <img src={profilePhoto} alt="Foto de perfil" className="w-full h-full object-cover object-[center_20%] scale-[1.6] grayscale group-hover:grayscale-0 transition-all duration-700" />
