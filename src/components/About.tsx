        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-7 lg:col-span-8 flex flex-col justify-between">
            ...
            <div className="text-background/80 text-lg leading-relaxed space-y-6">
              <p>Product Manager with 15 years of experience across Advertising and Technology. I’ve led multidisciplinary squads in fast-paced environments like QuintoAndar and Loft, Brazilians unicorns, building products for different contexts such as acquisition, retention, and operational efficiency.</p>
